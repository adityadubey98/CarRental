        ...
        {bookings.map((booking,index)=>(
          ...
          p-6 border border-borderColor rounded-lg mt-5 first:mt-12'>
              ...
              <div className='md:col-span-1'>
                <div className='rounded-md overflow-hidden mg-3'>
              ...
              <div className='md:col-span-2'>
                <div className='flex items-center gap-2'>
                  ...
                  <p className={`px-3 py-1 text-xs rounded-full ${booking.status === 'confirmed'? 'bg-green-400/45 text-green-600' : 'bg-red-400/15 text-red-600'}`}>{booking.status}</p>
                </div>
