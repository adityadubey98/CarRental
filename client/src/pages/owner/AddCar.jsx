...
const AddCar = () => {
  ...
  return (
    <div className="px-4 py-10 md:px-10 flex-1">
      <Title
        title="Add New Car"
        subtitle="Fill in details to list a 
      new car for booking, including pricing, availability, and car specifications."
      />
      ...
      >
        ...
        {/* Car Description */}
         ...
         <div className="flex flex-col w-full">
            ...
            <textarea
              rows={5}
              placeholder="e.g. A well-maintained car with excellent mileage and comfort."
              required
              className="px-3 py-2 mt-1 border border-borderColor rounded-md
              outline-none"
