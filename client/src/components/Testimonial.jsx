...
const Testimonial = () => {
    ...
    const testimonials = [
        ...
        { name: "Aman Dubey",
         ...
         image: assets.testimonial_image_1,
         testimonial: "I highly recommend CarRental for anyone looking for a reliable and luxurious car rental service. The staff was friendly and the process was seamless."
         }
    ];
  return (
