...
const Hero = () => {
  ...
  return (
    ...
    items-center gap-14 bg-light text-center'>
      
    <motion.h1 
    initial = {{y:50, opacity:0}}
    animate = {{y:0, opacity:1}}
    transition = {{duration:0.8, delay:0.2}}
    className='text-4xl md:text-5xl font-semibold'>Luxary cars on Rent</motion.h1>
    ...
    bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
      ...
      whileTap={{scale:0.95}}
      className='flex itmes-center justify-center gap-1 px-9 py-3
