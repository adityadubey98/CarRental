...
const Sidebar = () => {
  ...
  return (
    ...
    <div className='group relative'>
        <label htmlFor="image">
            <img src={image ? URL.createObjectURL(image) : user?.image || "https://unsplash.com/photos/a-winding-road-weaves-through-lush-green-trees-f0vvp9zJJwA"} alt="" className='h-9 md:h-14 w-9 md:w-14 rounded-full mx-auto' />
